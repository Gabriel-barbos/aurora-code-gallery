...
const Experience = () => {
  ...
  const experiences: Job[] = [
    ...
    },
    {
      id: "job2",
      company: "Outlier",
      position: "Expertise Coder for AI Training",
      startDate: "2024-10",
      endDate: null,
                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto">
                    <div className="p-6">
                        ...
                        <div className="flex-1 pr-4">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-3 text-sm text-neutral-500">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="break-words">{active.location}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div>
                          <h4 className="font-semibold mb-3 text-neutral-800 dark:text-neutral-200">Descrição</h4>
                          <p className="leading-relaxed">{active.description}</p>
                        </div>
                        
                        <div>
                          <h4 className="font-semibold mb-3 text-neutral-800 dark:text-neutral-200">Tecnologias Desenvolvidas</h4>
